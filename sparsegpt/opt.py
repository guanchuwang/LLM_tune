...
SAVE_DIR = '/scratch/zx22/gpt/pruned_models'
def get_opt(model):
    import torch
...
if __name__ == '__main__':
    ...
    if args.save:
        ...
        model.save_pretrained(f'{SAVE_DIR}/{args.dataset}/pretrained/{args.model}_{args.sparsity}')
        tokenizer.save_pretrained(f'{SAVE_DIR}/{args.dataset}/pretrained/{args.model}_{args.sparsity}')
