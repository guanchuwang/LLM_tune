...
CUDA_VISIBLE_DEVICES=$1 taskset -c 64-127 python soft_prompt_learning.py \
    --model_name_or_path /home/zx22/prompt/saved_models/llama/pruned_models/decapoda-research/llama-7b-hf_4bit \
    --model ${model} \
    --dataset ${dataset} \
